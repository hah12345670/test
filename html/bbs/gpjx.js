...
document.writeln("<font color=\'#0000FF\'><b>242期挂牌《批红判白》<br>");
document.writeln("解释：批：削；判：分开；红、白：指花卉。嫁接花木。<br>");
document.writeln("解：狗兔猪猴蛇龙，挂:03 爆:马<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：狗兔猪猴蛇龙鼠</font></span></p>");
