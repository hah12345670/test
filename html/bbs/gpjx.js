...
document.writeln("<font color=\'#0000FF\'><b>126期挂牌《四海朝宗》<br>");
document.writeln("解释：指全国各地四海为家将军既帝室之胄,信义著于四海。<br>");
document.writeln("解：猴蛇龙鼠猪牛，挂:34 爆:马<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：猴蛇龙鼠猪牛鸡</font></span></p>");
