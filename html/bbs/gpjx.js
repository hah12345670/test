...
document.writeln("<font color=\'#0000FF\'><b>244期挂牌《枕戈待旦》<br>");
document.writeln("解释：枕着兵器等待天明。形容时刻警惕，准备作战。<br>");
document.writeln("解：羊猪龙鼠兔猴，挂:02 爆:狗 <br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：羊猪龙鼠兔猴狗</font></span></p>");
