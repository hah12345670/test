...
document.writeln("");
document.writeln("<p style=\'font-size: 11pt; margin-bottom: 8px; text-align: left;\'>");
document.writeln("<font color=\'#0000FF\'><b>288期挂牌《栎阳雨金》<br>");
document.writeln("解释：意思是比喻意外的恩赐。出自《史记·秦本纪》。<br>");
document.writeln("解：牛鼠龙狗马虎。挂:03爆:虎，03牛冲羊，虎冲猴<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：牛鼠龙狗马虎猴</font></span></p>");
document.writeln("		<table style=border-collapse:collapse border=0 width=100%><tbody><tr>");
