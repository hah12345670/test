...
document.writeln("<font color=\'#0000FF\'><b>246期挂牌《蛮烟瘴雨》<br>");
document.writeln("解释：指南方有瘴气的烟雨。也泛指十分荒凉的地方。<br>");
document.writeln("解：马鼠狗兔猪猴，挂:23 爆:牛 <br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：马鼠狗兔猪猴龙</font></span></p>");
