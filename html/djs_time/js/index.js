(function() {
	let targettimestamp = new Date('2024-12-13 23:59:59').getTime()/1000; // 获取目标时间戳
	let nowtimestamp = new Date().getTime()/1000; // 获取当前时间戳
  // 总倒计时
  var totalTime = targettimestamp-nowtimestamp
