...
document.writeln("<font color=\'#0000FF\'><b>219期挂牌《铤而走险》<br>");
document.writeln("解释：指无路可走的时候采取冒险行动。。<br>");
document.writeln("解：鼠龙鸡牛狗猴，挂:07 爆:鼠<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：鼠龙鸡牛狗猴羊</font></span></p>");
