...
document.writeln("<font color=\'#0000FF\'><b>255期挂牌《祸生肘腋》<br>");
document.writeln("解释：肘腋：胳肢窝。比喻事变就发生在身边。。<br>");
document.writeln("解：牛马兔羊鼠龙，挂:04 爆:羊   <br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：牛马兔羊鼠龙虎</font></span></p>");
