...
document.writeln("<font color=\'#0000FF\'><b>127期挂牌《颠三倒四》<br>");
document.writeln("解释：形容说话、做事错乱，没有条理。<br>");
document.writeln("解：鸡鼠猪虎狗猴，挂:34 爆:马<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：鸡鼠猪虎狗猴牛</font></span></p>");
