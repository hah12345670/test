...
document.writeln("<font color=\'#0000FF\'><b>137期挂牌《东躲西藏》<br>");
document.writeln("解释：形容到处躲藏。也作“东藏西躲”<br>");
document.writeln("解：东肖兔虎龙，西肖猴鸡狗，挂:08 爆:马<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：兔虎龙猴鸡狗羊</font></span></p>");
