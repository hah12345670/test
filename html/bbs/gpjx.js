...
document.writeln("<font color=\'#0000FF\'><b>193期挂牌《不劳而获》<br>");
document.writeln("解释：意思是自己不劳动而占有别人的劳动成果。<br>");
document.writeln("解：鸡狗猴羊兔龙，挂:38 爆:龙<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：鸡狗猴羊兔龙蛇</font></span></p>");
