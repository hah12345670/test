...
document.writeln("<font color=\'#0000FF\'><b>153期挂牌《五湖四海》<br>");
document.writeln("解释：泛指全国或世界各地。［近］四面八方。<br>");
document.writeln("解：兔龙狗牛鼠蛇，挂:34爆:马<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：兔龙狗牛鼠蛇虎</font></span></p>");
