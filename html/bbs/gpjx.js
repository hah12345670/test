...
document.writeln("<font color=\'#0000FF\'><b>187期挂牌《五湖四海》<br>");
document.writeln("解释：意为全国各地，有时也指世界各地；现有时也比喻广泛的团结<br>");
document.writeln("解：龙鸡牛蛇鼠羊，挂::25 爆:鸡<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：龙鸡牛蛇鼠羊猴</font></span></p>");
