...
document.writeln("<font color=\'#0000FF\'><b>104期挂牌《水滴石穿》<br>");
document.writeln("解释：比喻坚持不懈，集细微的力量也能成就难能的功劳。<br>");
document.writeln("解：兔龙狗猴鼠猪，挂:33 爆:牛<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：兔龙狗猴鼠猪羊</font></span></p>");
