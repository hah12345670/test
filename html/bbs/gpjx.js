...
document.writeln("<font color=\'#0000FF\'><b>250期挂牌《无庸置疑》<br>");
document.writeln("解释：事实明显或理由充足，没有什么可以怀疑的。。<br>");
document.writeln("解：猴狗鸡虎羊兔，挂:35 爆:龙  <br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：猴狗鸡虎羊兔龙</font></span></p>");
