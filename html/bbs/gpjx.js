...
document.writeln("<font color=\'#0000FF\'><b>147期挂牌《风和日丽》<br>");
document.writeln("解释：和风习习，阳光明媚，形容天气晴朗暖和。<br>");
document.writeln("解：虎鼠猴鸡牛羊，挂:02 爆:狗<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：虎鼠猴鸡牛羊马</font></span></p>");
