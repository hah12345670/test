...
document.writeln("<font color=\'#0000FF\'><b>238期挂牌《闲愁万种》<br>");
document.writeln("解释：闲愁：说不出的烦恼。莫名的烦恼极多。形容思想空虚，多愁善感。也形容愁情满怀。<br>");
document.writeln("解：狗虎牛鼠龙羊，挂:34 爆:鼠 <br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：狗虎牛鼠龙羊猴</font></span></p>");
