...
document.writeln("");
document.writeln("<p style=\'font-size: 11pt; margin-bottom: 8px; text-align: left;\'>");
document.writeln("<font color=\'#0000FF\'><b>210期挂牌《十行俱下》<br>");
document.writeln("解释：【释义】意思是一次看十行，形容读书敏捷，记性很好。出自《梁书·简文帝纪》。<br>");
document.writeln("解：羊牛虎猴鼠马。挂:47爆:羊，47蛇冲猪，羊冲牛<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
