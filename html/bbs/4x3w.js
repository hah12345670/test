...
document.writeln("<b>");
document.writeln("<font color=\"#FF0000\">（146期开？00）</font><br");
...
document.writeln("<font style=\'font-size: 16pt\'>");
document.writeln("<b>");
document.writeln("<font color=\"#FF0000\">（145期开？00）</font><br");
document.writeln(">④肖（猴虎狗鼠）<br>");
document.writeln("③尾（3.0.9）<br>");
document.writeln("特主（09.33.03.39.19.43.29）");
document.writeln("");
document.writeln("</b></td>");
document.writeln("</tr>");
document.writeln("<!--结束-->");
...
document.writeln("<font style=\'font-size: 16pt\'>");
document.writeln("<b>");
document.writeln("<font color=\"#FF0000\">（142期开虎27）</font><br");
document.writeln(">④肖（</font><font color=\"#FF0000\" size=\"5\"><span style=\"background-color: #FFFF00\">虎</span></font><font style=\'font-size: 16pt\'>兔龙狗）<br>");
document.writeln("③尾（6.4.3）<br>");
document.writeln("特主（03.13.14.26.43.37）");
document.writeln("");
document.writeln("</b></td>");
document.writeln("</tr>");
document.writeln("<!--结束-->");
