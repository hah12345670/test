...
document.writeln("<font color=\'#0000FF\'><b>226期挂牌《人面桃花》<br>");
document.writeln("解释：形容男女邂逅钟情，随即分离之后，男子追念旧事的情形。<br>");
document.writeln("解：龙牛鼠兔蛇虎，挂:01 爆:蛇<br>");
document.writeln("</b></font>");
document.writeln("");
document.writeln("<span style=\'color: #FF00FF; font-family: 微软雅黑; text-indent: 2em; \'>");
document.writeln("");
document.writeln("");
document.writeln("<font size=\'3\'>七肖：龙牛鼠兔蛇虎猴</font></span></p>");
